...
public class RaccoonBaby extends Animal implements AnimatedEntity {
    public static final Identifier ID = Util.id("raccoon_baby");
    public static final Model MODEL = Raccoon.MODEL;
    private final EntityHolder<RaccoonBaby> holder;
    ...
    @Override public EntityHolder<RaccoonBaby> getHolder() { return this.holder; }

    public RaccoonBaby(EntityType<? extends @NotNull Animal> type, Level level) {
        super(type, level);
    ...
    @Override protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new FollowAdultGoal(this, 1.0, a -> a instanceof Raccoon));
    ...
    @Override public void tick() {
        super.tick();
        if (!this.level().isClientSide()) { babyAge++; BabyGrowthHelper.tryGrowUp(this, MobRegistry.RACCOON, babyAge, ageFrozen); }
